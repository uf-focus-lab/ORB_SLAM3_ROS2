...
void setup_publishers(ros::NodeHandle &, image_transport::ImageTransport &,
                      std::string);
...
void publish_keypoints(std::vector<ORB_SLAM3::MapPoint *>,
                       std::vector<cv::KeyPoint>, ros::Time);
sensor_msgs::PointCloud2 keypoints_to_pointcloud(std::vector<cv::KeyPoint> &,
                                                 ros::Time);
...
void publish_body_odom(Sophus::SE3f, Eigen::Vector3f, Eigen::Vector3f,
                       ros::Time);
...
sensor_msgs::PointCloud2
    mappoint_to_pointcloud(std::vector<ORB_SLAM3::MapPoint *>, ros::Time);
